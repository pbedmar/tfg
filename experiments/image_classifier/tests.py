...
def load_data(normalize_data=True):
    ...
    test_classes = generate_pair_sets(1000)
...
init_train_input, init_train_target, init_train_classes, test_input, test_target, test_classes =load_data(normalize_data=False)
print(init_train_classes)
print(init_train_classes[:,0])
print(init_train_classes.narrow(0, 0, 16)[:,0])
print("hola")