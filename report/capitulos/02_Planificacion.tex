...
\begin{itemize}
    ...
    \begin{itemize}
        \item \textbf{[T2.1]} Balancear el dataset.
    ...
    \end{itemize}
    \item \textbf{[T3]} Implementación de un modelo clasificador de imágenes, capaz de distinguir moléculas de ejemplos negativos.
    \begin{itemize}
        \item \textbf{[T3.1]} Entrenar sobre el dataset original y sobre el que contiene \textit{hard negatives}.
        \item \textbf{[T3.2]} Realizar pruebas con diferentes arquitecturas e hiperparámetros para comprobar cuáles se adaptan mejor al problema.
    \end{itemize}
...
\noindent Utilizamos distintos programas que nos apoyan en distintas tareas:
\begin{itemize}
